...
open class SharedViewModel @Inject constructor(application: Application) :
    ...
    private lateinit var sdkBoundService: WaireBluetoothService
    ...
    fun setBoundService(waireSdkBoundService: WaireBluetoothService) {
...
//            when (val flowResult = runCatching { sdkBoundService.discoverDevices() }) {
//                is UiResult.Success -> {
